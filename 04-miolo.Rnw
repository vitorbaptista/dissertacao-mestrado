...
SQLite\footnote{\url{https://www.sqlite.org/}}. Com os dados no banco, geramos
dois arquivos: um com os dados dos parlamentares e seus votos (tabela
\ref{table:votes}) e outro com os detalhes das votações (tabela
