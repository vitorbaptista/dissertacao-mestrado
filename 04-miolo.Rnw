...
apresentou o maior AUC foi o C5.0, com \Sexpr{ci(rocs.validation$C5.0)[[2]]}
...
\Sexpr{ci(rocs.testing$final)[[3]]}), como visto na figura
\ref{fig:roc-final-model}. Considerando o ponto de corte em
\Sexpr{cutoffPoint}, o modelo possui Kappa
