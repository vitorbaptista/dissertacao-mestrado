...
ambos sub-períodos em \Sexpr{format_percent(nrow(data_null) / num_mudancas)}
...
\Sexpr{format_percent(mean(coalition_changes_per_legislature["S",]))} mudanças,
...
\begin{tabular}{l l c c c c}
  ...
  SVM Radial & Custo & \Sexpr{models$svmRadial$bestTune$C} & \Sexpr{paste(lapply(ci(rocs.validation$svmRadial), format_inline), collapse = "&")} \\
             & Sigma & \Sexpr{gsub("\\.", ",", round(models$svmRadial$bestTune$sigma, 5))} & & & \\
