...
1988 e vai até a última legislatura completa disponível.
...
estudo agrupados por mês. Percebemos que há meses que concentram as mudanças de
...
n\textordmasculine{} 22.600 do TSE, que em
...
Percebe-se que essa mudança alterou a frequência de entradas e saídas da
...
% Período de mudança de comportamento
...
detectarmos as mudanças rapidamente, levando em conta que seguimos o padrão do
W-NOMINATE, que só considera parlamentares que participaram de pelo menos
20 votações com no mínimo 2,5\% de votos contrários a maioria. Baseado nisso,
...
% Objetivo % % Quais dados precisamos?
