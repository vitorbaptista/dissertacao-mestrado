...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: gbm\\\#\# Loading required package: survival\\\#\# \\\#\# Attaching package: 'survival'\\\#\# \\\#\# The following object is masked from 'package:caret':\\\#\# \\\#\#\ \ \ \  cluster\\\#\# \\\#\# Loading required package: splines\\\#\# Loaded gbm 2.1.1}}\end{kframe}
\end{knitrout}
...
sob a curva ROC usou 350, 1, 0.01, 10 preditores e chegou a área de
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prettyNum(.Internal(format(x, trim, digits, nsmall, width, 3L, : invalid 'digits' argument}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: gbm\\\#\# Loading required package: survival\\\#\# \\\#\# Attaching package: 'survival'\\\#\# \\\#\# The following object is masked from 'package:caret':\\\#\# \\\#\#\ \ \ \  cluster\\\#\# \\\#\# Loading required package: splines\\\#\# Loaded gbm 2.1.1}}\end{kframe}\begin{figure}
...
\hline
0.82787476650719 & 0.00 & 0.13 & 0.33 & 0.96 & 0.99 & 1.00\\
\hline
0.777863502303279 & 0.00 & 0.20 & 0.40 & 0.94 & 0.97 & 1.00\\
\hline
0.403157521070924 & 0.13 & 0.33 & 0.60 & 0.87 & 0.94 & 0.99\\
\hline
0.293869656569407 & 0.20 & 0.40 & 0.67 & 0.85 & 0.91 & 0.96\\
\hline
0.264296949579162 & 0.20 & 0.47 & 0.73 & 0.81 & 0.88 & 0.95\\
\hline
0.249162599449092 & 0.27 & 0.53 & 0.80 & 0.77 & 0.85 & 0.92\\
\hline
0.22097362201497 & 0.33 & 0.60 & 0.87 & 0.68 & 0.78 & 0.87\\
\hline
0.202833409138698 & 0.40 & 0.67 & 0.87 & 0.65 & 0.76 & 0.85\\
\hline
0.174243617535229 & 0.47 & 0.73 & 0.93 & 0.58 & 0.69 & 0.79\\
\hline
0.157624089731641 & 0.60 & 0.80 & 1.00 & 0.58 & 0.68 & 0.78\\
\hline
0.143219846299609 & 0.67 & 0.87 & 1.00 & 0.46 & 0.58 & 0.69\\
\hline
0.0971263319791297 & 0.80 & 0.93 & 1.00 & 0.27 & 0.37 & 0.49\\
\hline
0.0747345740755651 & 1.00 & 1.00 & 1.00 & 0.18 & 0.27 & 0.37\\
\hline
\end{tabular}
