...
e ``raio de influência'' apresentados na sessão
...
temporais descritos na sessão \ref{cap:miolo:aspectos-temporais}. A tabela
...
\begin{itemize}\raggedright
  ...
  \item Other packages: C50~0.1.0-24, caret~6.0-47,
    doParallel~1.0.8, e1071~1.6-4, foreach~1.4.2, gbm~2.1.1,
    ggplot2~1.0.1, ggthemes~2.2.1, iterators~1.0.7,
    kernlab~0.9-20, knitr~1.9, lattice~0.20-31, nnet~7.3-10,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    digest~0.6.8, evaluate~0.5.5, filehash~2.2-2, formatR~1.2,
    grid~3.2.1, gtable~0.1.2, gtools~3.4.2, highr~0.5,
    labeling~0.3, lme4~1.1-7, MASS~7.3-42, Matrix~1.2-2,
    mgcv~1.8-6, minqa~1.2.4, munsell~0.4.2, nlme~3.1-121,
    nloptr~1.0.4, partykit~1.0-2, pbkrtest~0.4-2, proto~0.3-10,
