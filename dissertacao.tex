...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figure/tmp/find-cutoff-1} \caption[Curva ROC do modelo final com o ponto de corte escolhido em destaque]{Curva ROC do modelo final com o ponto de corte escolhido em destaque.}\label{fig:find-cutoff}
\end{figure}
...
possui 6.314 observações, sendo
46.82\%
(2.956) relativas a
...
definição do ponto de corte em dois pontos: 0,5 e 0,65.
Considerando o corte em 0,5, no exemplo acima 166
parlamentares seriam classificados como tendo mudado de posicionamento,
sendo 87.35\%
(145) falsos positivos e 4 falsos negativos. Já
com o corte em 0,65, 53 seriam
classificados como tendo
mudado de posicionamento, sendo 77.36\% (41) falsos positivos
e 13 falsos negativos. Em outras palavras, ao mudar o ponto de
corte de 0,5 para 0,65, estamos trocando 104 falsos positivos a menos por 9
...
(considerando o ponto de corte em 0,65). De acordo com a
...
\label{cap:lista-pontos-de-corte}
