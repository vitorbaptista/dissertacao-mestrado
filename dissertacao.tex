...
\subfloat[O raio de influência da coalizão chega à metade do segundo período. A partir daqui começamos a considerar que houve uma mudança de posicionamento, pois o parlamentar esteve com outro comportamento em mais da metade da segunda parte do período.\label{fig:raio-de-influencia-coalizao2}]{\includegraphics[width=\maxwidth]{figure/tmp/raio-de-influencia-coalizao-2} }
\subfloat[A $Data_{media}$ se iguala à data de mudança. Este é o período onde esperamos encontrar a maior mudança de comportamento.\label{fig:raio-de-influencia-coalizao3}]{\includegraphics[width=\maxwidth]{figure/tmp/raio-de-influencia-coalizao-3} }
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\includegraphics[width=\maxwidth]{figure/tmp/variaveis-independentes-1} \caption[Densidade das variáveis independentes dos parlamentares em períodos que mudaram ou não de posicionamento]{Densidade das variáveis independentes dos parlamentares em períodos que mudaram ou não de posicionamento.}\label{fig:variaveis-independentes}
\end{figure}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\subfloat[Divisão do conjunto de dados usada para definir o tipo do modelo final e seus parâmetros.\label{fig:dataset-split-graphs1}]{\includegraphics[width=\maxwidth]{figure/tmp/dataset-split-graphs-1} }
\subfloat[Divisão do conjunto de dados usado para treinar o modelo final, definir seu o ponto de corte e estimar sua performance.\label{fig:dataset-split-graphs2}]{\includegraphics[width=\maxwidth]{figure/tmp/dataset-split-graphs-2} }\caption[Divisões do conjunto de dados usadas]{Divisões do conjunto de dados usadas.}\label{fig:dataset-split-graphs}
\end{figure}
