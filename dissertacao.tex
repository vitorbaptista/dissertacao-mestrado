...
\begin{itemize}\raggedright
  ...
  \item Other packages: C50~0.1.0-24, caret~6.0-47,
    ...
    lattice~0.20-31, plyr~1.8.2, pROC~1.8, randomForest~4.6-10,
    scales~0.2.4, survival~2.38-3, tikzDevice~0.8.1
  \item Loaded via a namespace (and not attached):
    ...
    nnet~7.3-10, partykit~1.0-2, pbkrtest~0.4-2, proto~0.3-10,
