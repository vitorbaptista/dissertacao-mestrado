...
do início da mudança de comportamento, $Data_{inicial}$ e
...
posicionamento compreende $\left(Data_{final} - \frac{P}{2}, Data_{final} +
\frac{P}{2}\right)$.

% FIXME: Corrigir o gráfico e melhorar a explicação textual.

Visualmente, temos \ref{fig:the-label} e \ref{fig:the-label1}:

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\subfloat[A data final está no limite do raio de influência da coalizão\label{fig:the-label1}]{\includegraphics[width=\maxwidth]{figure/tmp/the-label-1} }
\subfloat[O raio de influência da coalizão chega a metade do segundo período\label{fig:the-label2}]{\includegraphics[width=\maxwidth]{figure/tmp/the-label-2} }
\subfloat[A mudança de comportamento influencia blah\label{fig:the-label3}]{\includegraphics[width=\maxwidth]{figure/tmp/the-label-3} }
\subfloat[A mudança de comportamento está na metade do período inicial\label{fig:the-label4}]{\includegraphics[width=\maxwidth]{figure/tmp/the-label-4} }
\subfloat[O período inteiro ocorre depois da mudança de comportamento\label{fig:the-label5}]{\includegraphics[width=\maxwidth]{figure/tmp/the-label-5} }\caption[Diversos períodos de análise de um parlamentar que mudou de comportamento 6 meses antes de entrar ou sair da coalizão]{Diversos períodos de análise de um parlamentar que mudou de comportamento 6 meses antes de entrar ou sair da coalizão. Na região branca ele teve um comportamento, e na região verde teve outro.}\label{fig:the-label}
\end{figure}
