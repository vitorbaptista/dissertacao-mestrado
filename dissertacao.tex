...
\ref{cap:miolo:aspectos-temporais}. A linha tracejada marca a data da Resolução
...
\label{cap:miolo:estimando-mudanca-comportamento}
...
\label{cap:miolo:criterios-de-inclusao}
...
\label{cap:miolo:periodos-de-analise}
...
definidos na seção \ref{cap:miolo:criterios-de-inclusao}.
...
\label{cap:miolo:raio-de-influencia}
...
inclusão definidos na seção \ref{cap:miolo:criterios-de-inclusao}. Esses casos
...
o que possui a maior área sob a curva ROC (AUC). Encontrado esse modelo,
...
\ref{cap:miolo:raio-de-influencia}, e toma o valor ``S'', quando
...
\ref{cap:miolo:analise}, defini 6 variáveis independentes, sendo 4 relativas
