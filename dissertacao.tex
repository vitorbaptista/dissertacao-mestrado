...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in makePSOCKcluster(spec, ...): numeric 'names' must be >= 1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in registerDoParallel(cl): object 'cl' not found}}\begin{verbatim}
...
sob a curva ROC usou 6 preditores e chegou a área de
0,86 com desvio-padrão de 0,068.
